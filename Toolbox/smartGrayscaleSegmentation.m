...
function BW = smartGrayscaleSegmentation(imgO,pixelSpacing,seedPoints,tolerance,radius)

% SMARTGRAYSCALESEGMENTATION  segmentation method using grayscale level
%
%   Examples:
%      BW = SMARTGRAYSCALESEGMENTATION(imgO,pixelSpacing,seedPoints,tolerance,radius)
...
%% Step 6 Smart tolerance setup

if(meanHUROI > 525)    
    tolerance = 250;    
end

%% Step 6  Gray-scale segmentation
