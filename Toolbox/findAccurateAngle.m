function  angle = findAccurateAngle(reverseRotationControlIndex,ctpa)
% FINDACCURATEANGLE  find accurate angle for the rotation process
%
%   Examples:
...
roi = ctpa(:,:,reverseRotationControlIndex) > -300;
